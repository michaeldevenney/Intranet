...
namespace DAL
{
    ...
    public partial class LogController
    {
	    ...
	    public void Insert(int InventoryID,string Action,decimal NumberOfItems,string Notes)
	    {
		    Log item = new Log();
	    ...
	    public void Update(int Id,int InventoryID,string Action,decimal NumberOfItems,string Notes)
	    {
		    Log item = new Log();
	        item.MarkOld();
	        item.IsLoaded = true;
