...
namespace DAL
{
	...
	public partial class User : ActiveRecord<User>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Users", TableType.Table, DataService.GetInstance("VeritasInfo"));
				...
				colvarMobilePhone.IsNullable = false;
				...
				colvarOfficePhone.IsNullable = false;
				...
				DataService.Providers["VeritasInfo"].AddSchema("Users",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varName,string varMobilePhone,string varEmail,string varOfficePhone,string varUsername,string varPosition,string varStatus)
		{
			User item = new User();
		...
		/// </summary>
		public static void Update(int varId,string varName,string varMobilePhone,string varEmail,string varOfficePhone,string varUsername,string varPosition,string varStatus)
		{
			User item = new User();
