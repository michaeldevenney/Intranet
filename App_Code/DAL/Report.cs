...
namespace DAL
{
	...
	public partial class Report : ActiveRecord<Report>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Reports", TableType.Table, DataService.GetInstance("VeritasInfo"));
				...
				DataService.Providers["VeritasInfo"].AddSchema("Reports",schema);
			}
		}
		#endregion
