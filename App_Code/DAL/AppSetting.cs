...
namespace DAL
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the AppSettings table.
	/// </summary>
	[Serializable]
	public partial class AppSetting : ActiveRecord<AppSetting>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("AppSettings", TableType.Table, DataService.GetInstance("VeritasInfo"));
				...
				colvarAppName.ColumnName = "AppName";
				colvarAppName.DataType = DbType.AnsiString;
				colvarAppName.MaxLength = 50;
				colvarAppName.AutoIncrement = false;
				colvarAppName.IsNullable = true;
				colvarAppName.IsPrimaryKey = false;
				...
				TableSchema.TableColumn colvarAppSummary = new TableSchema.TableColumn(schema);
				colvarAppSummary.ColumnName = "AppSummary";
				colvarAppSummary.DataType = DbType.AnsiString;
				colvarAppSummary.MaxLength = 1000;
				colvarAppSummary.AutoIncrement = false;
				colvarAppSummary.IsNullable = true;
				colvarAppSummary.IsPrimaryKey = false;
				colvarAppSummary.IsForeignKey = false;
				colvarAppSummary.IsReadOnly = false;
				colvarAppSummary.DefaultSetting = @"";
				colvarAppSummary.ForeignKeyTableName = "";
				schema.Columns.Add(colvarAppSummary);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["VeritasInfo"].AddSchema("AppSettings",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("AppSummary")]
		[Bindable(true)]
		public string AppSummary 
		{
			get { return GetColumnValue<string>(Columns.AppSummary); }
			set { SetColumnValue(Columns.AppSummary, value); }
		}
		...
		/// </summary>
		public static void Insert(string varAppName,bool? varActive,string varAppSummary)
		{
			AppSetting item = new AppSetting();
			
			item.AppName = varAppName;
			
			item.Active = varActive;
			
			item.AppSummary = varAppSummary;
		...
		/// </summary>
		public static void Update(int varId,string varAppName,bool? varActive,string varAppSummary)
		{
			AppSetting item = new AppSetting();
        ...
        public static TableSchema.TableColumn AppSummaryColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string AppSummary = @"AppSummary";
