...
namespace DAL{
    /// <summary>
    /// Strongly-typed collection for the EstimateSummary class.
    /// </summary>
    [Serializable]
    public partial class EstimateSummaryCollection : ReadOnlyList<EstimateSummary, EstimateSummaryCollection>
    {        
        public EstimateSummaryCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the EstimateSummary view.
    /// </summary>
    [Serializable]
    public partial class EstimateSummary : ReadOnlyRecord<EstimateSummary>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("EstimateSummary", TableType.View, DataService.GetInstance("VeritasInfo"));
                ...
                DataService.Providers["VeritasInfo"].AddSchema("EstimateSummary",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public EstimateSummary()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public EstimateSummary(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public EstimateSummary(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public EstimateSummary(string columnName, object columnValue)
        {
            SetSQLProps();
