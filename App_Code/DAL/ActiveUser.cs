...
namespace DAL{
    ...
    public partial class ActiveUser : ReadOnlyRecord<ActiveUser>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("ActiveUsers", TableType.View, DataService.GetInstance("VeritasInfo"));
                ...
                DataService.Providers["VeritasInfo"].AddSchema("ActiveUsers",schema);
            }
        }
        #endregion
