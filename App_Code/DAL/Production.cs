...
{
	/// <summary>
	/// Strongly-typed collection for the Production class.
	/// </summary>
    [Serializable]
	public partial class ProductionCollection : ActiveList<Production, ProductionCollection>
	{	   
        ...
        /// </summary>
        /// <returns>ProductionCollection</returns>
		public ProductionCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the A_Production table.
	/// </summary>
	[Serializable]
	public partial class Production : ActiveRecord<Production>, IActiveRecord
	{
		...
		public Production(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Production(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public Production(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("A_Production", TableType.Table, DataService.GetInstance("VeritasInfo"));
				...
				DataService.Providers["VeritasInfo"].AddSchema("A_Production",schema);
			}
		}
		#endregion
