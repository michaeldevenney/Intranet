...
namespace DAL
{
	...
	public partial class TakeoffInfo : ActiveRecord<TakeoffInfo>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PM_TakeoffInfo", TableType.Table, DataService.GetInstance("VeritasInfo"));
				...
				DataService.Providers["VeritasInfo"].AddSchema("PM_TakeoffInfo",schema);
			}
		}
		#endregion
