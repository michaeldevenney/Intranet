...
namespace DAL
{
    ...
    public partial class UserController
    {
	    ...
	    public void Insert(string Name,string MobilePhone,string Email,string OfficePhone,string Username,string Position,string Status)
	    {
		    User item = new User();
	    ...
	    public void Update(int Id,string Name,string MobilePhone,string Email,string OfficePhone,string Username,string Position,string Status)
	    {
		    User item = new User();
	        item.MarkOld();
	        item.IsLoaded = true;
