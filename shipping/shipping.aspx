<%@ Page Title="Veritas Shipping" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="shipping.aspx.cs" Inherits="shipping_shipping" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContent" Runat="Server">
 ...
 <%--Project Section--%>
        ...
        <!-- ADDRESSES SECTION -->
        <div class="heading">
            <asp:Label ID="lblAddress" runat="server" Text="Address Information"></asp:Label>
